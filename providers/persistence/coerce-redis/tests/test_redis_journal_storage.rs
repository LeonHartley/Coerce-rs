...
pub async fn test_redis_journal_read_write_snapshot() {
    RedisTest::new(false, "test_redis_journal_read_write_snapshot:")
        .await
...
pub async fn test_redis_journal_read_write_messages() {
    RedisTest::new(false, "test_redis_journal_read_write_messages:")
        .await
...
pub async fn test_redis_journal_read_write_message_batch() {
    RedisTest::new(false, "test_redis_journal_read_write_message_batch:")
        .await
...
pub async fn test_redis_journal_read_single_message() {
    RedisTest::new(false, "test_redis_journal_read_single_message:")
        .await
        .test_message_batch_read_write()
        .await
}
...
pub async fn test_redis_journal_delete_messages_range() {
    RedisTest::new(false, "test_redis_journal_delete_messages_range:")
        .await
        .test_message_batch_read_write()
        .await
}
