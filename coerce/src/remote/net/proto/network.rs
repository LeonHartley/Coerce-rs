...
pub mod actor_ref_err {
    ...
    impl ::protobuf::Enum for ErrorType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<ErrorType> {
            match str {
                "ActorUnavailable" => ::std::option::Option::Some(ErrorType::ActorUnavailable),
                "NotFound" => ::std::option::Option::Some(ErrorType::NotFound),
                "AlreadyExists" => ::std::option::Option::Some(ErrorType::AlreadyExists),
                "Serialisation" => ::std::option::Option::Some(ErrorType::Serialisation),
                "Deserialisation" => ::std::option::Option::Some(ErrorType::Deserialisation),
                "Timeout" => ::std::option::Option::Some(ErrorType::Timeout),
                "ActorStartFailed" => ::std::option::Option::Some(ErrorType::ActorStartFailed),
                "InvalidRef" => ::std::option::Option::Some(ErrorType::InvalidRef),
                "ResultChannelClosed" => ::std::option::Option::Some(ErrorType::ResultChannelClosed),
                "ResultSendFailed" => ::std::option::Option::Some(ErrorType::ResultSendFailed),
                "NotSupported" => ::std::option::Option::Some(ErrorType::NotSupported),
                "NotImplemented" => ::std::option::Option::Some(ErrorType::NotImplemented),
                _ => ::std::option::Option::None
            }
        }
...
impl ::protobuf::Enum for Event {
    ...
    fn from_str(str: &str) -> ::std::option::Option<Event> {
        match str {
            "Identify" => ::std::option::Option::Some(Event::Identify),
            "Handshake" => ::std::option::Option::Some(Event::Handshake),
            "Result" => ::std::option::Option::Some(Event::Result),
            "Err" => ::std::option::Option::Some(Event::Err),
            "Ping" => ::std::option::Option::Some(Event::Ping),
            "Pong" => ::std::option::Option::Some(Event::Pong),
            "CreateActor" => ::std::option::Option::Some(Event::CreateActor),
            "FindActor" => ::std::option::Option::Some(Event::FindActor),
            "RegisterActor" => ::std::option::Option::Some(Event::RegisterActor),
            "NotifyActor" => ::std::option::Option::Some(Event::NotifyActor),
            "StreamPublish" => ::std::option::Option::Some(Event::StreamPublish),
            "Raft" => ::std::option::Option::Some(Event::Raft),
            "Identity" => ::std::option::Option::Some(Event::Identity),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for ClientType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<ClientType> {
        match str {
            "Client" => ::std::option::Option::Some(ClientType::Client),
            "Worker" => ::std::option::Option::Some(ClientType::Worker),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for SystemEvent {
    ...
    fn from_str(str: &str) -> ::std::option::Option<SystemEvent> {
        match str {
            "ClusterNewNode" => ::std::option::Option::Some(SystemEvent::ClusterNewNode),
            "ClusterNodeRemoved" => ::std::option::Option::Some(SystemEvent::ClusterNodeRemoved),
            "ClusterLeaderChanged" => ::std::option::Option::Some(SystemEvent::ClusterLeaderChanged),
            "ClusterMemberUp" => ::std::option::Option::Some(SystemEvent::ClusterMemberUp),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for MessageUnwrapErr {
    ...
    fn from_str(str: &str) -> ::std::option::Option<MessageUnwrapErr> {
        match str {
            "UnknownUnwrapErr" => ::std::option::Option::Some(MessageUnwrapErr::UnknownUnwrapErr),
            "UnwrapUnsupported" => ::std::option::Option::Some(MessageUnwrapErr::UnwrapUnsupported),
            "DeserializationErr" => ::std::option::Option::Some(MessageUnwrapErr::DeserializationErr),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for MessageWrapErr {
    ...
    fn from_str(str: &str) -> ::std::option::Option<MessageWrapErr> {
        match str {
            "UnknownWrapErr" => ::std::option::Option::Some(MessageWrapErr::UnknownWrapErr),
            "WrapUnsupported" => ::std::option::Option::Some(MessageWrapErr::WrapUnsupported),
            "SerializationErr" => ::std::option::Option::Some(MessageWrapErr::SerializationErr),
            _ => ::std::option::Option::None
        }
    }
